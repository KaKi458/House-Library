...
import com.houselibrary.api.request.AuthorRequest;
  ...
  private Subcategory getSubcategoryFromRequest(BookRequest bookRequest, Category category) {
    ...
    if (subcategory == null) {
      ...
      if (subcategory.getCategory() != category) {
        throw new HouseLibraryException(HttpStatus.BAD_REQUEST, "Given subcategory does not belong to given category");
      }
    }
    return subcategory;
  }
